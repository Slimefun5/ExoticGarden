...
public final class FoodRegistry {
    ...
    public static void register(@Nonnull ExoticGarden plugin, @Nonnull ItemGroup misc, @Nonnull ItemGroup drinks, @Nonnull ItemGroup food) {
        ...
        new SlimefunItem(misc, new SlimefunItemStack("CORNMEAL", MaterialCompat.safe(XMaterial.SUGAR), "\u00a7rCornmeal"), RecipeType.GRIND_STONE,
        ...
        new CustomFood(food, new SlimefunItemStack("CORN_ON_THE_COB", MaterialCompat.safe(XMaterial.GOLDEN_CARROT), "\u00a76Corn on the Cob", "", "\u00a77\u00a7oRestores \u00a7b\u00a7o" + "4.5" + " \u00a77\u00a7oHunger"),
