...
public final class ExoticGardenRecipeTypes {
    ...
    public static final RecipeType BREAKING_GRASS = new RecipeType(new NamespacedKey(ExoticGarden.instance, "breaking_grass"), CustomItemStack.create(Material.GRASS, "\u00a77Breaking Grass"));
