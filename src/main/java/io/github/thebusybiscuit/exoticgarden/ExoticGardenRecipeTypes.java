...
public final class ExoticGardenRecipeTypes {
    ...
    public static final RecipeType KITCHEN = new RecipeType(new NamespacedKey(ExoticGarden.instance, "kitchen"), new SlimefunItemStack("KITCHEN", MaterialCompat.safe(XMaterial.CAULDRON), "\u00a7eKitchen"), "", "\u00a7rThis item must be made", "\u00a7rin a Kitchen");
